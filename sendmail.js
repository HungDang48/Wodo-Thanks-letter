  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; padding: 20px; background-color: #f4f4f9;">
        <h2 style="color: #2c3e50;">Xin chào, đây là WODO đến từ Better World Camp 2025 <img src="cid:WodoImage" style="width: 100%; max-width: 50px;" alt="Wodo" /></h2> 
        ...
        <p>𝒯𝒽â𝓃 𝒶́𝒾 𝒷ắ𝓉 𝓉𝒶𝓎 𝓉𝓇𝒶́𝒾</p>
        <p style="color: #5D18E5; font-size: 25px;"><strong>𝓦𝓞𝓓𝓞</strong></p>
        <p style="color: #F36A33; font-size: 20px;"><strong>𝒲𝑜𝓊𝓁𝒹 𝓉𝒽𝒾𝓃𝓀𝓈</strong></p>
        <p style="color: #F36A33; font-size: 20px;"><strong>𝒲𝑜𝓊𝓁𝒹 𝒹𝑜</strong></p>
    ...
    attachments: [
      ...
      {
        filename: 'Wodo2.png',
        path: __dirname + "/assets/Wodo2.png",
        cid: 'WodoImage'
      }
    ]
  };
